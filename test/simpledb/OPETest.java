...
public class OPETest {
    ...
    @Before public void setupOPETest() throws Exception {
        ...
        this.ope_div_2 = new OPE(div_2);
        this.ope_line_3_1 = new OPE(line_3_1);

        Type types[] = new Type[]{ Type.INT_TYPE, Type.INT_TYPE, Type.INT_TYPE };
        String names[] = new String[]{ "field0", "field1", "field2" };
        TupleDesc td = new TupleDesc(types, names);
        this.table = new HeapFile(new File("ope_test.dat"), td);
        Database.getCatalog().addTable(table, "ope_test");
        this.table_iter = table.iterator(new TransactionId());
    }

    @Test public void testOPEAdd() throws DbException, TransactionAbortedException {
        ...
        while (this.table_iter.hasNext()) {
          ...
          for (int i = 0; i < num_fields; i++) {
            ...
            if (field.getType() == Type.INT_TYPE) {
              ...
              Integer val_dec = key_pair.decrypt(val_orig);
