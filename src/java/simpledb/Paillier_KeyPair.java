...
public class Paillier_KeyPair implements KeyPair, Serializable {
     ...
     * @return The corresponding plaintext. If an upper bound was given to {@link Paillier_KeyPairBuilder},
     * the result can also be negative. See {@link Paillier_KeyPairBuilder#upperBound(BigInteger)} for details.
     */
